...
| **[Nome do Membro 2]** | [Descrever a principal contribuição e aprendizado individual relacionado à modelagem UML, análise dos requisitos, rastreabilidade ou trabalho em equipe.] | [Descrever como a IA foi utilizada pelo membro, quais sugestões foram aproveitadas ou descartadas e como ocorreu a validação das respostas.] |
| **[Nome do Membro 3]** | [Descrever a principal contribuição e aprendizado individual relacionado à modelagem UML, análise dos requisitos, rastreabilidade ou trabalho em equipe.] | [Descrever como a IA foi utilizada pelo membro, quais sugestões foram aproveitadas ou descartadas e como ocorreu a validação das respostas.] |
