...
A Subequipe 01 é responsável pelo desenvolvimento e documentação dos modelos de arquitetura orientados à notação UML para o projeto, que tem como objeto de estudo o Fluxo de Navegação A:  Login, Perfil de Usuário e Segurança.
