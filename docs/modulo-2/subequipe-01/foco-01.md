...
1. [**Rich Picture**](#/modulo-1/subequipe-01): utilizado para identificar atores, elementos do domínio, relações, problemas e expectativas presentes no ecossistema de autenticação e gerenciamento da conta.

2. [**BPMN**](#/modulo-1/subequipe-01): utilizado para identificar as etapas, decisões e responsabilidades presentes nos fluxos de **login, cadastro e recuperação/alteração de senha**.

3. [**NFR Framework/SIG**](#/modulo-1/subequipe-01): utilizado para identificar as preocupações de qualidade e os comportamentos necessários para atender aos requisitos de **segurança, usabilidade, confiança, consistência e feedback**.

4. [**Product Backlog**](#/extras/subequipe01_product_backlog): utilizado para transformar os achados anteriores em itens funcionais e não funcionais priorizados, que posteriormente foram utilizados como referência para identificar os conceitos e classes do domínio.
...
A construção do diagrama foi orientada pelos itens do **Product Backlog do Fluxo A** identificados durante a análise. Cada grupo de classes representa uma ou mais funcionalidades rastreadas aos artefatos anteriores.
...
| **NFR / Confiança** | Atividades de segurança e transparência | **PB-14** | `Sessao`, `NotificacaoSeguranca` |
| **Rich Picture / Login social** | Gerenciamento de vínculos sociais | **PB-15** | `AutenticacaoSocial`, `ProvedorSocial` |
...
[7] OPENAI. *ChatGPT*. Disponível em: [https://chatgpt.com/](https://chatgpt.com/). Acesso em: 17 set. 2026.
...
| 0.2 | 17/09/2026 | Inclusão da modelagem estática, rastreabilidade com o Product Backlog e decisões de projeto | [**Dylan Cavalcante**](https://github.com/dylancavalcante) | [Samuel Felipe](https://github.com/TerminaKng05) |
| 0.3 | 17/09/2026 | Refinamento do diagrama Mermaid, enumerações e distinção entre elementos observados e propostos | [**Dylan Cavalcante**](https://github.com/dylancavalcante) | [Mariana Ribeiro](https://github.com/marianagonzaga0) |