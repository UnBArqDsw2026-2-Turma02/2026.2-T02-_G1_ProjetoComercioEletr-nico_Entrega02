...
| **Elaboração do Diagrama de Sequência — Compra na Decathlon** | Uires Carlos de Oliveira e Nayra Silva Nery (trabalho conjunto) | Revisão mútua entre Uires, Diassis e Nayra | Inserir link do commit do diagrama |
| **Elaboração do Diagrama de Atividades — Navegação por Modalidade** | Uires Carlos de Oliveira e Nayra Silva Nery (trabalho conjunto) | Revisão mútua entre Uires, Diassis e Nayra | Inserir link do commit do diagrama |
