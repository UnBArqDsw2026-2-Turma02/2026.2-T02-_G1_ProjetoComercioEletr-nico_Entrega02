...
- **Decisão de Comportamento 01:** [Descreva a decisão de fluxo/troca de mensagens enviadas].
  - **Fundamentação:** Segundo Fowler (2003, p. XX), *"..."*.
- **Decisão de Comportamento 02:** [Descreva a escolha de determinado fragmento de controle ou padrão de interação].
  - **Fundamentação:** Conforme Larman (2007), o uso da interação X garante o desacoplamento das chamadas...
